...
export default function Footer({ currentLang }) {
  ...
  const footerLinks = [
    ...
    { id: "#history", ar: "تاريخ الألقاب", en: "Legacy" },
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 flex flex-col gap-4">
            ...
            <p className="text-gray-500 text-xs leading-relaxed">
              {currentLang === "ar"
                ...
                : "The unofficial website of Maghreb Association Sportive de Fès. The Tigers' Fortress."}
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-500 text-xs hover:text-white transition-colors cursor-pointer">
              +212 535 000 000
            </p>
          </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-[10px] text-gray-600 uppercase tracking-widest">
          <p>© {currentYear} MAS FES. ALL RIGHTS RESERVED.</p>
          <p>
            DEVELOPED BY{" "}
            <a
